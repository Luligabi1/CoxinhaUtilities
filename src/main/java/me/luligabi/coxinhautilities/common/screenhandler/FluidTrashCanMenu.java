...
public class FluidTrashCanMenu extends AbstractContainerMenu {

    private final Container inventory;

    public FluidTrashCanMenu(int syncId, Inventory playerInventory) {
        this(syncId, playerInventory, new SimpleContainer(1));
    }

    public FluidTrashCanMenu(int syncId, Inventory playerInventory, Container inventory) {
        super(MenuTypeRegistry.FLUID_TRASH_CAN.get(), syncId);
