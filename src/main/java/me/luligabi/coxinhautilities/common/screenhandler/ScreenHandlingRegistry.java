...
public class ScreenHandlingRegistry {
    ...
    public static void init() {
        ...
        FLUID_TRASH_CAN_SCREEN_HANDLER = Registry.register(Registry.SCREEN_HANDLER, new Identifier(CoxinhaUtilities.MOD_ID, "fluid_trash_can"), new ScreenHandlerType<>(FluidTrashCanScreenHandler::new));
