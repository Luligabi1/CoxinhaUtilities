...
public class EnergyTrashCanScreenHandler extends AbstractContainerMenu {

    private final Container inventory;

    public EnergyTrashCanScreenHandler(int syncId, Inventory playerInventory) {
        this(syncId, playerInventory, new SimpleContainer(1));
    }

    public EnergyTrashCanScreenHandler(int syncId, Inventory playerInventory, Container inventory) {
